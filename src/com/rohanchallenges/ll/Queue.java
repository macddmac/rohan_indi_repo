...
public class Queue<T> implements Iterable<T> {
    com.rohanchallenges.ll.LinkedList<T> head, tail;
    ...
    public void add(T data) {
        ...
        com.rohanchallenges.ll.LinkedList<T> tail = new com.rohanchallenges.ll.LinkedList<>(data, null);
     ...
     */
    public com.rohanchallenges.ll.LinkedList<T> getHead() {
        return this.head;
    }
     ...
     */
    public com.rohanchallenges.ll.LinkedList<T> getTail() {
        return this.tail;
    }
...
class QueueIterator<T> implements Iterator<T> {
    com.rohanchallenges.ll.LinkedList<T> current;  // current element in iteration
